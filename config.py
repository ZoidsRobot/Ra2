...
# Databasenya 
DB_URI = os.environ.get("DATABASE_URL", "dLVUOr8RYw3A1qLfQ_wDy46Tgn8Ua4HC@balarama.db.elephantsql.com")
...
FORCE_SUB_GROUP = int(os.environ.get("FORCE_SUB_GROUP", "-1001768189200"))
